...
else if($_SESSION['power']!=0&&$_SESSION['power']!=3)
{
	die('<div style="text-align:center;color:#990000;font-family:Microsoft Yahei;">抱歉，您没有订单管理的权限</div>');
}
?>	
...
<div id="container">
        <div style="padding-bottom:5px;" id="searchdiv">
                    <form id="searchForm" method="get">
                            <div class="searchbox">
                            <div id="inputbox">
                            <input type="text" name="booksuggest" value="请输入订单号" class="birds" id="booksuggest" />
