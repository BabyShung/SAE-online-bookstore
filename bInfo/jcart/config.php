...
$config['item']['img']            = 'my-item-img';    // Item img
$config['item']['add']            = 'my-add-button';    // Add to cart button
$config['item']['addbn']            = 'my-add-buttonbn';    // Add to cart button

// Your PayPal secure merchant ID in SandBox ащФтНЛвз
// Found here: https://www.paypal.com/webapps/customerprofile/summary.view
$config['paypal']['id']           = 'seller_1330946186_biz@qq.com';
