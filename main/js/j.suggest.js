			...
			function displayItems(items) {
				...
				if (items=='') {  //若textbox为空
					...
					for (i = 0; i < options.source.length; i++) 
					{
						...
						html += '<li rel="' + options.source[i][0] + '" style="padding:0px; margin:0px; border:0px; text-align:left;"><a href="#' + i + '" style=" font-weight:normal; width:281px; padding-top:10px;padding-left:3px; margin:0px;border:0px; text-align:left;-webkit-border-radius: 0px;-moz-border-radius: 0px;border-radius: 0px;">' + options.source[i][1] + '</a></li>';
						j++;
						}
					}
